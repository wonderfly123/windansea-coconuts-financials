...
Project-local context for this repo. Auto-loaded by Claude when working here.
...
typed notes survive). Data is reachable only through MCP in a Claude session, so the app
